      ...
      <div className="max-w-screen-2xl flex flex-col items-center justify-self-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {chatCards.map((card) => (
            ...
            >
              <div className="h-full bg-bgCards border shadow-xl rounded-lg p-6 transition-all duration-300 hover:border-gray-600 hover:transform hover:-translate-y-1 flex flex-col justify-between">
