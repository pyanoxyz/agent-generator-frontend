...
export const AgentDetails: React.FC<AgentDetailsProps> = ({
  ...
  return (
    <div className="relative h-full flex flex-col bg-black md:bg-transparent">
      {/* Fixed Header */}
      <div className="sticky top-0 z-50 bg-black md:bg-black/30 backdrop-blur-sm border-b border-gray-800">
        <div className="flex items-center justify-between p-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-lg md:text-2xl font-bold text-white">{character.name}</h2>
      ...
      <div className="flex-1 overflow-y-auto">
        <div className="space-y-6 md:space-y-8 p-4 md:p-6">
          {/* Bio Section */}
          <div className="bg-black/30 rounded-lg p-4 md:p-6 border border-gray-800">
            <div className="flex items-center gap-2 mb-3 md:mb-4">
              <FaRobot className="text-blue-400" />
              <h3 className="text-base md:text-lg font-medium text-white">Bio</h3>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
            ...
            <div className="bg-black/30 rounded-lg p-4 md:p-6 border border-gray-800">
              <div className="flex items-center gap-2 mb-3 md:mb-4">
                ...
                <h3 className="text-base md:text-lg font-medium text-white">Topics</h3>
              </div>
            ...
            <div className="bg-black/30 rounded-lg p-4 md:p-6 border border-gray-800">
              <div className="flex items-center gap-2 mb-3 md:mb-4">
                ...
                <h3 className="text-base md:text-lg font-medium text-white">Personality</h3>
              </div>
              <div className="flex flex-wrap gap-2">
          ...
          <div className="border-t border-gray-800 pt-4 md:pt-6">
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center gap-2">
                ...
                <h3 className="text-lg md:text-xl font-semibold text-white">Agent Logs</h3>
              </div>
              <button
                onClick={handleRefreshLogs}
                className="flex items-center gap-1.5 md:gap-2 px-2.5 md:px-3 py-1.5 text-xs md:text-sm text-gray-400 hover:text-white bg-gray-800/50 hover:bg-gray-800 rounded-lg transition-colors"
              >
            ...
            <div className="bg-black/50 rounded-lg border border-gray-800">
              {isLoadingLogs ? (
                ...
                <pre className="p-3 md:p-4 text-xs md:text-sm text-gray-300 font-mono whitespace-pre-wrap overflow-x-auto max-h-72 md:max-h-96 overflow-y-auto scrollbar-thin scrollbar-thumb-gray-800 scrollbar-track-transparent">
                  {logs}
                </pre>
              ) : (
          ...
          <div className="border-t border-gray-800 pt-4 md:pt-6">
            ...
            <div className="space-y-2 text-xs md:text-sm">
              ...
              <div className="flex justify-between py-2 border-b border-gray-800">
                ...
                <span className="text-gray-300 break-all">{agent.agent_id}</span>
              </div>
            </div>
          </div>
      ...
      {/* Mobile Bottom Bar */}
      {isMobile && (
        <div className="sticky bottom-0 left-0 right-0 p-4 bg-black border-t border-gray-800">
          <button
            onClick={onClose}
            className="w-full py-3 px-4 bg-gray-800 hover:bg-gray-700 text-white rounded-lg transition-colors"
          >
            Close Details
          </button>
        </div>
