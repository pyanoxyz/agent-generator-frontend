            ...
            array.map((item, index) => (
              <div key={index} className="group relative">
                ...
                <button
                  ...
                  className="absolute top-1/2 -translate-y-1/2 right-3 h-8 w-8 flex items-center justify-center text-red-500 hover:text-red-400 border border-red-800 rounded-lg opacity-0 group-hover:opacity-100 transition-opacity bg-secondary"
                >
                  x
                </button>
              </div>
    ...
    <>
      <div className="space-y-6">
        ...
        {renderStringArrayField(
          ...
          config.lore,
          <div>
            Backstory elements and unique character traits. <br /> These help define personality and
            can be randomly sampled in conversations.
          </div>
        )}
        {renderStringArrayField(
          "Knowledge",
          ...
          config.knowledge,
          <div>
            Can contain chunks of text from articles, books, or other sources <br />
        ...
        {renderStringArrayField(
          ...
          config.topics,
          <div>
            List of subjects the character is interested in or knowledgeable about <br />
